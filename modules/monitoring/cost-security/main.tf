# Cost Security Module - Fixed Version
# File: modules/monitoring/cost-security/main.tf
...
# CloudTrail for API monitoring - Fixed event selector
resource "aws_cloudtrail" "security_trail" {
  ...
  # Simplified event selector - management events only (removed invalid ECS cluster data resource)
  event_selector {
    read_write_type           = "All"
